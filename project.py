...
def about():
  print(
      " This project is Developed by Tanmay Bansal and Jay  on HOTEL MANAGEMENT SYSTEM........it contain 17 option..In this project 4 csv files are used Customers,roomtype,laundry,restaurants"
  )
...
def new_customer():
  ...
  df.at['11', :] = [
      'sara', '50,karol bagh', '8860671794', '18-06-2022', '22-06-2022', '4'
  ]
  print(df)
...
def new_column():
  ...
  df = pd.read_csv("customers.csv",
                   skiprows=1,
                   names=[
                       'customer name', 'Residence', 'Day of arrival',
                       'Day of departure', 'stay'
                   ])
  print(df)
...
def roomrent():
  print(
      "Room includes:1 double bed,Television,1 double door cupboard,1 coffee table with 2 sofa,bedroom attached washroom with hot/cold water"
  )
...
def rent_int():
  ...
  print()
  df = pd.read_csv("roomtype.csv", index_col=0)
  print(df)
...
def show_restaurant():
  ...
  print('MENU')
  df = pd.read_csv("Resturant.csv", index_col=0)
  print(df)
...
while True:
  ...
  if user_input == 'q':
    print("Thank you for visiting our hotel.....Visit us again!!!")
    break
